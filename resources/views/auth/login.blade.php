            ...
            <div>
                <form id="loginForm" class="tooltip-end-bottom" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3 filled form-group tooltip-end-top">
                        ...
                        <input class="form-control  @error('email') is-invalid @enderror" placeholder="Email" name="email" id="email" />
                        @error('email')
                    ...
                    <div class="mb-3 filled form-group tooltip-end-top">
                        ...
                        <input id="password" class="form-control pe-7  @error('password') is-invalid @enderror" name="password" type="password" placeholder="Password" />
